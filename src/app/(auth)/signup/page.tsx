    ...
    <div className="rounded-xl border border-border bg-card p-8 shadow-lg">
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-lg border border-border bg-background px-4 py-2 text-sm font-medium text-card-foreground hover:bg-accent"
        >
